...
stats.MSE = mean((data.maskedSet1 - data.maskedSet2).^2);
stats.RMSE2 = sqrt(stats.MSE);
stats.MAE = mean(abs(data.maskedSet1-data.maskedSet2));
...
for i=1:length(params.corrInfo)
	switch upper(params.corrInfo{i})
        ...
        case 'MSE', corrtext = [corrtext; ['MSE=' mynum2str(stats.MSE,2) params.unitsStr]];
